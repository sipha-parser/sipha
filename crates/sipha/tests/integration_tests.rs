...
fn test_lexer_grammar_integration() {
    ...
    let grammar = GrammarBuilder::new()
        ...
        .rule(CalcNonTerminal::Expr, Expr::token(create_calc_token(
...
fn test_error_handling() {
    use sipha::error::{ParseError, LexerError, LexerErrorKind};
    ...
    assert_eq!(parse_error.span(), TextRange::new(TextSize::from(0), TextSize::from(5)));
    ...
    assert_eq!(lexer_error.span(), TextRange::new(TextSize::from(10), TextSize::from(11)));
