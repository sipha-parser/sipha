...
//!
//! ```rust
//! use sipha::context::{ParseContext, FlagId};
//!
...
///
/// Stored in the grammar's [`FlagMaskTable`](crate::insn::FlagMaskTable) and
/// referenced by index from [`Insn::PushFlags`](crate::insn::Insn::PushFlags).
