...
//! [`crate::parse::engine::ParseOutput::tree_events`].  Text is sliced out of
...
//! foundation for zero-copy incremental reparsing. With the **`incremental`**
//! Cargo feature, `sipha::parse::incremental` rebuilds after a text edit while
//! reusing unchanged `Arc`s.
//!
//! ## Trivia
//!
...
//! such as [`crate::tree::red::SyntaxNode::non_trivia_tokens`] and
//! [`crate::tree::red::SyntaxNode::token_groups`].
...
pub struct GreenToken {
    ...
    pub kind: SyntaxKind,
    /// Byte length of the `text` field below.  Equal to `text.len() as u32`.
    pub text_len: u32,
...
impl GreenNode {
    ...
    /// original source use [`crate::tree::red::SyntaxNode::text`].
    #[must_use]
